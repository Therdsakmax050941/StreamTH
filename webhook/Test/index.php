...
if ($profileJson == true) {
    ...
    if ($text == 'สมัครบริการเพิ่มเติม') {
        ...
        // เรียกใช้ฟังก์ชันเพื่อดึงข้อมูลรายการสินค้า
        $products = getProductsFromDatabase();
        // เรียกใช้ฟังก์ชันเพื่อสร้าง Flex Message จากข้อมูลรายการสินค้า
        $flexMessageJson = createFlexMessageFromProducts($products);
        // เรียกใช้ฟังก์ชันเพื่อส่ง Flex Message ไปยังผู้ใช้
        $result = sendFlexMessage($userId, $flexMessageJson, $logFilePath);
